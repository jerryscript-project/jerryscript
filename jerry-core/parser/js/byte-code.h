...
#define CBC_OPCODE_LIST \
  ...
  /* These 6 branch opcodes must be in this order. */ \
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_TRUE_FORWARD, -1, \
                      VM_OC_BRANCH_IF_TRUE | VM_OC_BRANCH_GET_STACK) \
  ...
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_FALSE_FORWARD, -1, \
                      VM_OC_BRANCH_IF_FALSE | VM_OC_BRANCH_GET_STACK) \
  ...
  CBC_OPCODE (CBC_BOOL_AND_BRANCH, CBC_NO_FLAG, 0, \
              VM_OC_BOOL_AND_BRANCH | VM_OC_GET_STACK) \
  \
