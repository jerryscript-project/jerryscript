...
#define CBC_OPCODE_LIST \
  ...
  /* Binary assignment add opcodes. */ \
  /* Note: The order of the CBC assignment add opcodes must follow the order of the CBC assignment opcodes  */\
  CBC_OPCODE (CBC_ASSIGN_ADD, CBC_NO_FLAG, -3, \
              VM_OC_ASSIGN_ADD | VM_OC_GET_STACK | VM_OC_PUT_REFERENCE) \
  CBC_OPCODE (CBC_ASSIGN_ADD_PUSH_RESULT, CBC_NO_FLAG, -2, \
              VM_OC_ASSIGN_ADD | VM_OC_GET_STACK | VM_OC_PUT_REFERENCE | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_ASSIGN_ADD_BLOCK, CBC_NO_FLAG, -3, \
              VM_OC_ASSIGN_ADD | VM_OC_GET_STACK | VM_OC_PUT_REFERENCE | VM_OC_PUT_BLOCK) \
  CBC_OPCODE (CBC_ASSIGN_ADD_SET_IDENT, CBC_HAS_LITERAL_ARG, -1, \
              VM_OC_ASSIGN_ADD_IDENT | VM_OC_GET_STACK_LITERAL | VM_OC_PUT_IDENT) \
  CBC_OPCODE (CBC_ASSIGN_ADD_SET_IDENT_PUSH_RESULT, CBC_HAS_LITERAL_ARG, 0, \
              VM_OC_ASSIGN_ADD_IDENT | VM_OC_GET_STACK_LITERAL | VM_OC_PUT_IDENT | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_ASSIGN_ADD_SET_IDENT_BLOCK, CBC_HAS_LITERAL_ARG, -1, \
              VM_OC_ASSIGN_ADD_IDENT | VM_OC_GET_STACK_LITERAL | VM_OC_PUT_IDENT | VM_OC_PUT_BLOCK) \
  CBC_OPCODE (CBC_ASSIGN_ADD_LITERAL_SET_IDENT, CBC_HAS_LITERAL_ARG | CBC_HAS_LITERAL_ARG2, 0, \
              VM_OC_ASSIGN_ADD_IDENT_LITERAL | VM_OC_GET_LITERAL_LITERAL | VM_OC_PUT_IDENT) \
  CBC_OPCODE (CBC_ASSIGN_ADD_LITERAL_SET_IDENT_PUSH_RESULT, CBC_HAS_LITERAL_ARG | CBC_HAS_LITERAL_ARG2, 1, \
              VM_OC_ASSIGN_ADD_IDENT_LITERAL | VM_OC_GET_LITERAL_LITERAL | VM_OC_PUT_IDENT | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_ASSIGN_ADD_LITERAL_SET_IDENT_BLOCK, CBC_HAS_LITERAL_ARG | CBC_HAS_LITERAL_ARG2, 0, \
              VM_OC_ASSIGN_ADD_IDENT_LITERAL | VM_OC_GET_LITERAL_LITERAL | VM_OC_PUT_IDENT | VM_OC_PUT_BLOCK) \
  CBC_OPCODE (CBC_ASSIGN_ADD_PROP_LITERAL, CBC_HAS_LITERAL_ARG, -2, \
              VM_OC_ASSIGN_ADD_PROP | VM_OC_GET_STACK_LITERAL | VM_OC_PUT_REFERENCE) \
  CBC_OPCODE (CBC_ASSIGN_ADD_PROP_LITERAL_PUSH_RESULT, CBC_HAS_LITERAL_ARG, -1, \
              VM_OC_ASSIGN_ADD_PROP | VM_OC_GET_STACK_LITERAL | VM_OC_PUT_REFERENCE | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_ASSIGN_ADD_PROP_LITERAL_BLOCK, CBC_HAS_LITERAL_ARG, -2, \
              VM_OC_ASSIGN_ADD_PROP | VM_OC_GET_STACK_LITERAL | VM_OC_PUT_REFERENCE | VM_OC_PUT_BLOCK) \
