                                      ...
                                      ecma_value_t radix) /**< routine's second argument */
{
  ...
  if (r != 0)
  {
    ...
    if (r < 2 || r > 36)
    {
      ...
      *ret_num = ecma_number_make_nan ();
      ret_value = ecma_make_normal_completion_value (ecma_make_number_value (ret_num));
    }
    /* 8.b */
    else if (r != 16)
    {
  ...
  if (ecma_is_completion_value_empty (ret_value))
  {
    ...
    for (int i = start; i < end; i++)
    {
      ...
      else
      {
        ...
        zt_string_buff[i] = (ecma_char_t) r;
      }

      if (!(zt_string_buff[i] < r))
      {
        end = i;
        break;
      }
  ...
  if (ecma_is_completion_value_empty (ret_value))
  {
    ecma_number_t *value = ecma_alloc_number ();
    *value = 0;
    ...
    {
      *value += (ecma_number_t) zt_string_buff[i] * multiplier;
      multiplier *= (ecma_number_t) r;
    }
    ...
    ret_value = ecma_make_normal_completion_value (ecma_make_number_value (value));
  }
