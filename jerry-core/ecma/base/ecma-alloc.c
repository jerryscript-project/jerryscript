 ...
 * @return pointer to allocated memory
 */
JERRY_ALWAYS_INLINE(ecma_object_t *)
 ...
 * @return pointer to allocated memory
 */
JERRY_ALWAYS_INLINE(ecma_extended_object_t *)
 ...
 * @return pointer to allocated memory
 */
JERRY_ALWAYS_INLINE(ecma_string_t *)
 ...
 * @return pointer to allocated memory
 */
JERRY_ALWAYS_INLINE(ecma_extended_string_t *)
 ...
 * @return pointer to allocated memory
 */
JERRY_ALWAYS_INLINE(ecma_external_string_t *)
 ...
 * @return pointer to allocated memory
 */
JERRY_ALWAYS_INLINE(ecma_property_pair_t *)
