                           ...
                           uint32_t arguments_number) /**< number of arguments */
{
  ...
  switch (operation)
  {
#if JERRY_BUILTIN_SET || JERRY_BUILTIN_WEAKSET
...
#endif /* JERRY_BUILTIN_SET || JERRY_BUILTIN_WEAKSET */
#if JERRY_BUILTIN_MAP || JERRY_BUILTIN_WEAKMAP
...
#endif /* JERRY_BUILTIN_MAP || JERRY_BUILTIN_WEAKMAP */
