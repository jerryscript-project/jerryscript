...
CONFIG_DISABLE_ES2015_SET_BUILTIN
...
* `CONFIG_DISABLE_ES2015_SET_BUILTIN`:
  Disable the [Set](http://www.ecma-international.org/ecma-262/6.0/#sec-set-objects) built-in.
* `CONFIG_DISABLE_ES2015_TEMPLATE_STRINGS`:
...
* `CONFIG_DISABLE_ES2015`: Disable all of the implemented [ECMAScript2015 features](http://www.ecma-international.org/ecma-262/6.0/).
  ...
  `CONFIG_DISABLE_ES2015_PROMISE_BUILTIN`, `CONFIG_DISABLE_ES2015_SET_BUILTIN`, `CONFIG_DISABLE_ES2015_TEMPLATE_STRINGS`, and `CONFIG_DISABLE_ES2015_TYPEDARRAY_BUILTIN`).
