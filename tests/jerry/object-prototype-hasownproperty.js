...
try {
  obj1.hasOwnProperty({toString: function() {
...
var obj_undef;
var obj3 = {};
Object.defineProperty(obj3, 'Test', { 'get': function() {
  throw new ReferenceError('foo');
} });
assert(obj3.hasOwnProperty('Test') === true);

Object.defineProperty(obj3, 'Test2', { 'get': function() {
  return 0/0;
} });
assert(obj3.hasOwnProperty('Test2') === true);

Object.defineProperty(obj3, 'Test4', { 'get': function() {
  return obj_undef;
} });
