...
{
  ecma_string_t *properties_str_p = ecma_get_magic_string (ECMA_MAGIC_STRING__EMPTY);
...
{
  /* 10.b */
  ecma_string_t *comma_str_p = ecma_get_magic_string (ECMA_MAGIC_STRING_COMMA_CHAR);
  ecma_string_t *line_feed_p = ecma_get_magic_string (ECMA_MAGIC_STRING_NEW_LINE_CHAR);
...
{
  /* 2.c.iii */
  ecma_string_t *hex_str_p = ecma_get_magic_string (ECMA_MAGIC_STRING__EMPTY);
  ...
  hex_str_p = ecma_new_ecma_string ((ecma_char_t *) hex_buff);
