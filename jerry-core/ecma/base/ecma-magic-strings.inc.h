...
ECMA_MAGIC_STRING_DEF (ECMA_MAGIC_STRING_LEFT_BRACE_CHAR, "{")
ECMA_MAGIC_STRING_DEF (ECMA_MAGIC_STRING_RIGHT_BRACE_CHAR, "}")
...
ECMA_MAGIC_STRING_DEF (ECMA_MAGIC_STRING_DOUBLE_QUOTE_CHAR, "\"")
ECMA_MAGIC_STRING_DEF (ECMA_MAGIC_STRING_BACKSLASH_CHAR, "\\")
ECMA_MAGIC_STRING_DEF (ECMA_MAGIC_STRING_NEW_LINE_CHAR, "\n")
